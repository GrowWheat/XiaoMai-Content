...
XiaoMai's **Content Separation Architecture** (Dual-Repository Architecture) decouples these two concerns: your content resides independently in your private content repository, while the theme code repository handles pulling content, compiling static assets, and rendering the site.
