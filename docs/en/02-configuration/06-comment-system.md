...
XiaoMai follows the **Zero Extra Burden Principle**: when the comment system is disabled (`enable: false` or omitted), the theme issues zero external network requests and loads 0 third-party client-side JavaScript, maintaining pristine performance.
