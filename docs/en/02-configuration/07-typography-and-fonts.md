...
XiaoMai categorizes typography into 3 distinct roles:
...
CJK font files typically range from 15MB to 30MB, which severely impacts page load speed if shipped intact. XiaoMai includes a fully automated Chinese/CJK font subsetting pipeline:
