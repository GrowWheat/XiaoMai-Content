...
Articles reside in the content repository under `content/posts/`. XiaoMai supports two organization styles:
...
XiaoMai provides a suite of Material 3 Expressive Markdown components:
