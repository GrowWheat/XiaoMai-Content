...
This is the **most strongly recommended** deployment strategy for XiaoMai.
...
1. Open your **theme code repository** (e.g., `XiaoMai`);
...
In a dual-repository architecture, if you push changes to your content repository and theme code repository simultaneously, or make multiple rapid pushes to your content repository, XiaoMai provides robust **concurrency preemption and automatic cancellation**:
