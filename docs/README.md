# XiaoMai 官方文档 / Documentation

[简体中文](./zh-CN/README.md) | [English](./en/README.md)

欢迎查阅 XiaoMai 博客主题使用文档。你可以点击上方链接进入对应语言的完整手册，也可以直接通过下方目录浏览各章节。

Welcome to the XiaoMai documentation. Choose your preferred language above to read the full guide, or browse chapters directly using the table of contents below.
...
| 06   | [评论系统配置](./zh-CN/02-configuration/06-comment-system.md) | [Comment System](./en/02-configuration/06-comment-system.md) | 零额外负担原则与 Twikoo / Giscus 评论接入 |
